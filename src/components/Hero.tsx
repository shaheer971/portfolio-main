        ...
        <div className="flex flex-col items-start max-w-3xl mx-0 py-0">
          ...
          <div className="md:text-6xl leading-tight md:leading-tight tracking-tight lg:text-2xl text-2xl font-semibold py-[7px] md:pt-[20px]">
            ...
            <div className="inline-block mt-1 font-bold text-white">
              <SplitText text="an aspiring designer and developer." delay={150} textAlign="left" threshold={0.2} animationFrom={{
              opacity: 0,
              transform: "translate3d(0,20px,0)"
            }} animationTo={{
              opacity: 1,
          ...
          duration: 0.6,
          delay: 0.6
        }} className="mt-1.5 text-lg md:text-xl text-white/80 max-w-2xl leading-relaxed my-0">I help transform complex ideas into elegant digital experiences - crafting products that combine functionality with visual excellence.</motion.p>
          <motion.div initial={{
          opacity: 0,
          filter: "blur(8px)"
        }} animate={{
